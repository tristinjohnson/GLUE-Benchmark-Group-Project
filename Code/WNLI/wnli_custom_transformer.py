"""
Tristin Johnson
GLUE Dataset - Winograd NLI (WNLI)
DATS 6450 - NLP
December 9th, 2021
"""
...
def train_and_test(train_loader, val_loader, transformer):
    ...
    for epoch in range(num_epochs):
        ...
        if model_acc > model_best_acc:
            torch.save(model.state_dict(), 'wnli_best_model.pt')
            print('This model has been saved as wnli_best_model.pt !')
...
# best acc with ALBERT - train 0.49606 (:12 per epoch), val - 0.56338 (0:01 per epoch)
# best acc with ELECTRA - train 0.51496 (0:03 per epoch), val - 0.56338 (0:01 per epoch)
